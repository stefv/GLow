...
{
    /// <summary>
    /// Return a readonly icon when the shader can't be changed.
    /// </summary>
    public class ReadOnlyConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                bool b = (bool)value;
                if (b) return new BitmapImage(new Uri("/GLow Screensaver;component/Images/locked.png", UriKind.Relative));
            }
            return null;
        }
